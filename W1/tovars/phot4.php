...
<header class="header cont">
    ...
    <content>
        <table>
            <tr>
                <td class="leftcol"><img class="tovar_item" src="../style/img/Son1.jpg"></td>
                <h1>Фотоаппараты</h1>
                <td class="disp" valign="top">Sony L-340<br>
                <p class="opis">Sony может похвастаться мощным зум-объективом с диапазоном фокусных расстояний 24-600mm и светосилой F/2.4-4. Скорость серийной съёмки достигает 14 кадров в секунду. Также имеется возможность записи 4K-видео.</p>
                <p>600$</p>
