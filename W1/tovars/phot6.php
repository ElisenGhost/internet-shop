...
<header class="header cont">
    ...
    <content>
        <table>
            <tr>
                <td class="leftcol"><img class="tovar_item" src="../style/img/or.jpg"></td>
                <h1>Фотоаппараты</h1>
                <td class="disp" valign="top">Nikon J-100<br>
                <p class="opis">Прикоснитесь к звездам. Парите вместе с орлами. С невероятным 125-кратным оптическим зумом для вас больше нет пределов. Теперь на фото и видео можно запечатлеть то, что раньше было недосягаемо.</p>
                <p>500$</p>
                    <form action="../inc/corz.php" method="POST">
					    <input type="hidden" name="tovar_id" value="6" id="6">
