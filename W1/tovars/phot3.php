...
<header class="header cont">
    ...
    <content>
        <table>
            <tr>
                <td class="leftcol"><img class="tovar_item" src="../style/img/xa.jpg"></td>
                <h1>Фотоаппараты</h1>
                <td class="disp" valign="top">Canon M-790<br>
                <p class="opis">Canon PowerShot представляют собой простые в обращении средние по классу фотоаппараты с несъёмными объективами. В то же время, камеры серии PowerShot не являются цифровыми компактными камерами начального уровня.</p>
                <p>350$</p>
